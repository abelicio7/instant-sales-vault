...
export const Guarantee = () => (
  <section className="py-20 bg-secondary/30">
    <div className="container">
      <div className="max-w-3xl mx-auto flex flex-col md:flex-row items-center gap-8 p-8 md:p-10 rounded-3xl bg-gradient-card border border-border shadow-card-elevated">
        <div className="relative shrink-0">
          <div className="absolute inset-0 bg-brand-green/30 blur-2xl rounded-full" />
          <div className="relative h-28 w-28 rounded-full bg-gradient-cta flex items-center justify-center shadow-glow-green">
        ...
        <div className="text-center md:text-left">
          <h3 className="text-2xl md:text-3xl font-black mb-2">Garantia incondicional de 7 dias</h3>
