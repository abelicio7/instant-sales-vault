...
export const CTA = () => (
  <section id="cta" className="py-20 md:py-28 bg-background relative overflow-hidden">
    ...
    <div className="container relative">
      <div className="max-w-4xl mx-auto text-center p-8 md:p-14 rounded-3xl bg-gradient-card border border-brand-green/40 shadow-glow-green">
        <span className="inline-block text-xs font-bold tracking-[0.2em] uppercase text-brand-yellow mb-4 px-3 py-1 rounded-full border border-brand-yellow/40 bg-brand-yellow/10">
        ...
        <div className="mt-8 flex flex-col items-center">
          <div className="flex items-center gap-3 mb-6">
            <span className="text-5xl md:text-6xl font-black text-brand-yellow">197 Mt</span>
          ...
          <Button variant="ctaYellow" size="hero" asChild className="w-full sm:w-auto">
            <a href="https://my.debito.co.mz/pay/b29587ee-8f58-40e6-a36c-f01477cd8c9d" target="_blank" rel="noopener noreferrer">
              Quero Acesso ao Pacote Completo <ArrowRight />
            </a>
          </Button>
