...
export const Solution = () => (
  <section className="py-20 md:py-28 bg-secondary/30 relative overflow-hidden">
    ...
    <div className="container relative">
      ...
      <div className="mt-10 md:mt-14 grid md:grid-cols-3 gap-5 md:gap-6 max-w-5xl mx-auto">
        {pillars.map(({ icon: Icon, title, desc }, i) => (
          <div
            key={title}
            className="relative p-6 md:p-8 rounded-3xl bg-gradient-card border border-border shadow-card-elevated hover:-translate-y-1 transition-smooth animate-fade-up"
