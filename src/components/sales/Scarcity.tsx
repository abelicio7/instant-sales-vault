...
export const Scarcity = () => (
  <section className="py-16 bg-gradient-yellow text-brand-black relative overflow-hidden">
    ...
    <div className="container relative">
      <div className="flex flex-col md:flex-row items-center justify-center gap-6 text-center md:text-left">
        <div className="flex items-center gap-3">
          <AlertTriangle className="h-10 w-10 animate-blink" />
        ...
        <div>
          ...
          <p className="mt-2 text-base md:text-lg font-semibold opacity-80">
